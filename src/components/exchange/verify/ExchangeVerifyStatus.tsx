 ...
 */
export const ExchangeVerifyStatus = ({ verified, expired, exchange_id }: Props) => {
      ...
      {verified ? (
        <>
          ...
          <div className="flex flex-col items-center gap-y-4">
            <p className="w-1/3 text-center">Verificaste com sucesso que aceitas a troca!</p>
            <Button onClick={() => navigate('/exchange')}>Voltar para os pedidos</Button>
          </div>
        </>
      ) : (
        <>
