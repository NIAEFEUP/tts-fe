...
export const CommonCardHeader = ({
  ...
  return (
    <CardHeader className="flex flex-row items-center gap-x-2 p-4">
      <img className="h-10 w-10 rounded-full shadow-md" src={studentInfoService.getStudentPictureUrl(username)}></img>
