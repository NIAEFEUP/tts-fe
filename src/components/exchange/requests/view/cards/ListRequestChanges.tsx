        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <label htmlFor={option.course_info.acronym} className="cursor-pointer">
              ...
              <div className="mb-3">
                <h3 className="font-medium text-base text-gray-900 text-left">{option.course_info.acronym}</h3>
                <p className="text-xs text-gray-500 leading-tight mt-0.5 text-left">{option.course_info.name}</p>
                {userWillExchangeTo && (
                  <p className="text-xs text-blue-600 font-medium mt-1 text-left">Troca com {userWillExchangeTo}</p>
                )}
              </div>
