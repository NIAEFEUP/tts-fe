...
export const AlreadyEnrolledCourseUnitCard = ({ courseUnit, enrollmentChoices, setEnrollmentChoices }: Props) => {
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between px-4 py-2">
        ...
        >
          {removeSelected ? 'Cancelar pedido' : 'Anular inscrição em turma'}
        </Button>
      </CardHeader>
    </Card>
  )
