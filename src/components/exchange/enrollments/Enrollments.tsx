      ...
      <div className="relative flex flex-row flex-wrap items-center justify-center gap-x-2 gap-y-2 lg:justify-start">
        ...
        <div className="flex w-full flex-col gap-y-4">
          <div className="flex flex-col gap-y-2">
            {enrollCourses?.length > 0 && <h3 className="text-md font-bold">Cadeiras a inscrever</h3>}
          ...
          <div className="flex flex-col gap-y-2">
            {alreadyEnrolledCourseUnits.length === 0 ? (
              <h3 className="text-md flex flex-col items-center justify-center text-center font-bold">
                <LockClosedIcon className="mb-2 h-12 w-12" />
          ...
          {(enrollmentChoices.size > 0 || disenrollmentChoices.size > 0) && (
            ...
            >
              <Button className="w-full">Submeter</Button>
            </form>
          )}
        </div>
      </div>
