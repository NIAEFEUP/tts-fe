...
export const AdminSidebar = () => {
  ...
  return (
    <Sidebar className="flex h-screen flex-col bg-white">
      <SidebarHeader className="flex flex-row gap-2 p-4">
        <RectangleGroupIcon className="h-6 w-6" />
        <h1 className="font-bold">Admin</h1>
      </SidebarHeader>
      <Separator />
      <SidebarContent className="m-4 flex-1 overflow-auto">
        <SidebarMenu>
      ...
      <SidebarFooter className="mt-auto flex flex-col gap-2">
        ...
        <SidebarMenuButton asChild>
          <Button
            variant="secondary"
            className="bg-primary hover:bg-primary/90 flex w-full flex-row justify-center gap-2 text-white"
