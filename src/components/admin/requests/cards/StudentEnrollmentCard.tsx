 ...
 */
export const StudentEnrollmentCard = ({ enrollment }: Props) => {
      ...
      <CardHeader className="flex flex-row items-center justify-between px-9 py-4">
        <div className="flex items-center gap-4">
          <div className="flex flex-col gap-1 ">
            ...
            {!open && <RequestDate date={enrollment.date} />}
          </div>
          {!open && (
            <>
              <Person
            ...
            <div className="flex flex-row justify-between">
              ...
              <div className="flex flex-row gap-x-2">
                {[...enrollment.options]
                  ...
                  .map((option) => (
                    <div key={option.id}>
                      <div className="flex flex-row items-center gap-x-2 rounded-md border-2 border-gray-200 p-2 px-4">
              ...
              <div>
                <AdminPreviewSchedule
                  ...
                  classesToAdd={enrollment.options.map((option): ClassDescriptor => {
                    return {
