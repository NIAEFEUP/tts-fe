                                    ...
                                    <>{exchange.options.map((option) => (
                                        <div key={crypto.randomUUID()} className="flex gap-5 items-center">
                                            ...
                                            <div className="flex gap-2 items-center">
                                                ...
                                                <p>{getVacanciesFromCourseUnitAcronymAndClassName(option.course_info.acronym,option.class_issuer_goes_from.name) ?? 'N/A'} vagas</p>
                                                <ArrowRightIcon className="w-5 h-5" />
                                                <p>{option.class_issuer_goes_to.name}</p>
                                                <p>{getVacanciesFromCourseUnitAcronymAndClassName(option.course_info.acronym,option.class_issuer_goes_to.name) ?? 'N/A'} vagas</p>
                                            </div>
                                        </div>
                                    ))}
                                    </>
