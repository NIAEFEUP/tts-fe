        ...
        <div className="flex flex-col gap-y-4 p-4">
          ...
          <Tabs defaultValue="exchange-with-student">
            <TabsList className="w-full">
              <TabsTrigger value="exchange-with-student" onClick={() => setCurrPage(1)}>
                Trocas entre estudantes
              </TabsTrigger>
              <TabsTrigger value="exchange-singular" onClick={() => setCurrPage(1)}>
                Trocas urgentes
              </TabsTrigger>
              <TabsTrigger value="enrollments" onClick={() => setCurrPage(1)}>
                Inscrições
              </TabsTrigger>
              <TabsTrigger value="admin-marketplace" onClick={() => setCurrPage(1)}>
                Trocas individuais
              </TabsTrigger>
            </TabsList>
