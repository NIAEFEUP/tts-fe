...
const Sidebar = () => {
  ...
  return (
    <div
      className="order-2 col-span-12 flex min-h-min flex-col justify-between rounded-4xl bg-lightest p-6 dark:bg-dark lg:col-span-3 lg:min-h-adjusted 2xl:px-4 2xl:py-4
