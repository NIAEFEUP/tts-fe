...
const ScheduleColorLabels = () => {
  ...
  return (
    <>
      {/* Labels */}
      <div className="mt-4 hidden items-end justify-start space-x-2 2xl:flex 2xl:space-x-4">
        ...
        <div className="flex flex-col space-y-1 text-xxs 2xl:space-y-2 2xl:text-xs">
          ...
          <div className="inline-flex items-center gap-1 lg:gap-1.5">
            <span className="h-3.5 w-3.5 rounded bg-schedule-default/80 shadow 2xl:h-4 2xl:w-4" />
            <span>Outros</span>
          </div>
        </div>
      </div>
      ...
      {/* Modal show all */}
      <div className="mt-4 flex 2xl:hidden">
