...
const ConfirmationModal = ({ major, isOpen, closeModal, confirmationAction }) => (
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col mt-3 text-left">
                <p>Estás a importar um horário de um curso diferente do teu:
                  <b title={major?.name ?? ''}> {major?.acronym ?? ''}</b>.
                  Se continuares, as tuas <b>opções atuais serão perdidas</b>.
                </p>
              </div>
