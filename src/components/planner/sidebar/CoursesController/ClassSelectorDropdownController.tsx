...
const NoTeachersFound = ({ mobile }: { mobile: boolean }) => {
  return (
    <div className="mx-2">
      {mobile ? <></> : <Desert className="h-24 w-full" />}
      <p className="my-4 text-center text-sm">Não há professores associados a nenhuma turma desta disciplina.</p>
    </div>
  )
}
...
const NoOptionsFound = ({ mobile }: { mobile: boolean }) => {
  return (
    <div>
      {mobile ? <></> : <Desert className="h-24 w-full" />}
      <p className="my-4 text-center text-sm">Esta disciplina não tem nenhuma turma.</p>
    </div>
  )
}
            ...
            <div className="hidden lg:block">
              <DropdownMenuGroup>
                <DropdownMenuSub>
                  ...
                  <DropdownMenuPortal>
                    <DropdownMenuSubContent className="bg-lightish text-darkish dark:bg-darkish dark:text-lightish w-80">
