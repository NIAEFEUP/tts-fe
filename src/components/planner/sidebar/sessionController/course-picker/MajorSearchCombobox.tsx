...
import { Fragment, useState, useEffect, useRef, SetStateAction, useContext } from 'react'
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          {selected ? majors.find((major) => major.id === selected.id)?.name : 'Seleciona um curso...'}
              ...
              {filteredMajors.map((major) => (
                <CommandItem
                  ...
                  onSelect={(currentMajor) => {
                    // setSelectedMajor(currentMajor === selectedMajor.id ? null : currentMajor)
                    setOpen(false)
                  }}
                >
