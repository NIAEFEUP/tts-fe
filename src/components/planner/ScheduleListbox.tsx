  ...
  return schedules ? (
    ...
    >
      <div className="relative">
        <h4 className="mb-0.5 text-sm">
          {course.info.name} (<strong>{course.info.acronym}</strong>)
        </h4>
        <Listbox.Button className="relative w-full cursor-default rounded-lg border-2 bg-white py-2 pl-3 pr-10 text-left sm:text-sm">
        ...
        <Transition as={Fragment} leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
          <Listbox.Options className="absolute z-20 mt-1 max-h-60 w-full overflow-auto rounded-md border bg-white py-1 text-base sm:text-sm">
