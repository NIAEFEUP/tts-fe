  ...
  return (
    <div className="m-4 grid grid-cols-1 gap-4 sm:m-8 sm:grid-cols-2 sm:gap-6 lg:m-12 lg:grid-cols-3 lg:gap-12">
      {features.map((feature, index) => (
        <div key={index} className="dark:bg-dark rounded-lg bg-white p-4 text-center shadow-lg sm:p-5">
          <Button className="border-primary text-primary hover:bg-secondary dark:text-primary relative left-0 top-0 mx-auto h-16 w-16 flex-grow cursor-default rounded-full border-4 bg-inherit sm:h-20 sm:w-20 dark:bg-inherit">
