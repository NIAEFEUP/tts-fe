...
import { AboutPage, ProfilePage, FeupExchangePage, TimeTableSchedulerPage, NotFoundPage, FaqsPage, TestPage } from './pages'
...
const pages = [
  ...
  { path: getPath(config.paths.test), location: 'Test', element: TestPage, liquid: true }
]
