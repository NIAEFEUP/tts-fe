...
const pages = [
  {
    ...
    liquid: true,
    description:
      'Sobre o Time Table Selector - Plataforma desenvolvida por NIAEFEUP para ajudar estudantes da FEUP a criar e gerir horários.',
  ...
  },
  {
    ...
    liquid: true,
    description:
      'Crie e experimente diferentes combinações de horários para o seu semestre na FEUP. Visualize conflitos e otimize a sua agenda.',
  ...
  },
  {
    ...
    liquid: true,
    description:
      'Perguntas frequentes sobre o Time Table Selector - Tire as suas dúvidas sobre a plataforma de horários da FEUP.',
  ...
  },
  {
    ...
    liquid: true,
    description:
      'Troque de turmas com outros estudantes da FEUP. Pedidos de troca diretos e gestão de trocas de horários.',
...
const App = () => {
  ...
  useEffect(() => {
    fetch(`${api.BACKEND_URL}/csrf/`, { credentials: 'include' })
      .then(() => {})
      ...
      <CombinedProvider>
        <>
          <SentryRoutes>
            ...
            <Route path="admin" key="page-admin" element={<AdminPage page="pedidos" />} />
