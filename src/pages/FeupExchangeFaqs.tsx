...
const FeupExchangePageFaqs = () => {
    ...
    return (
        <div className="container mx-auto w-full space-y-12 py-6 px-4 md:py-10 ">
            <div >
                <h2 className="mb-2 text-center text-3xl font-bold uppercase text-primary"> Perguntas mais frequentes</h2>
            </div>
