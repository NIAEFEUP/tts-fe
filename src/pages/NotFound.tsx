...
const NotFoundPage = () => (
  <div className="flex flex-col items-center justify-between space-y-4 py-8 md:flex">
    ...
    <Link
      ...
      className="border-primary bg-primary flex h-auto w-fit items-center justify-center rounded border-2 px-3 py-2 text-xs font-medium text-white transition hover:opacity-80 lg:text-sm xl:px-4"
    >
      Voltar ao Horário
    </Link>
  </div>
