...
const ExchangeSidebarStatusView = ({
  ...
  sidebarStatus: ExchangeSidebarStatus
...
const ExchangePage = () => {
  ...
  if (!signedIn)
    return (
      ...
      >
        <div className="w-cfull grid grid-cols-12 gap-x-4 gap-y-4 px-4 py-4">
          <div className="lg:min-h-adjusted bg-lightest dark:bg-dark order-1 col-span-12 min-h-min rounded px-3 py-3 lg:col-span-9 2xl:px-5 2xl:py-5">
            <div className="h-full w-full">
              <Schedule classes={[]} slots={[]} />
            </div>
          </div>

          <div className="lg:min-h-adjusted bg-lightest dark:bg-dark order-2 col-span-12 flex min-h-min flex-col justify-between rounded px-3 py-3 lg:col-span-3 2xl:px-4 2xl:py-4">
  ...
  return (
    ...
    >
      <div className="mx-4 block lg:hidden">
      ...
      <div className="w-cfull grid grid-cols-12 gap-x-4 gap-y-4 px-4 py-4">
        {/* Schedule Preview */}
        <div className="lg:min-h-adjusted bg-lightest dark:bg-dark order-1 col-span-12 min-h-min rounded px-6 py-6 lg:col-span-9 2xl:px-5 2xl:py-5  ">
          <div className="h-full w-full">
            {!sigarraSynced && !loadingSchedule && (
              <>
                <Alert variant="destructive" className="my-2 mb-4">
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>O horário reflete trocas que ainda não estão no sigarra</AlertDescription>
                </Alert>
              </>
            )}
        ...
        <div className="lg:min-h-adjusted bg-lightest dark:bg-dark order-2 col-span-12 flex h-[85vh] flex-col overflow-y-auto rounded px-3 py-3 lg:col-span-3 2xl:px-4 2xl:py-4">
                    ...
                    {!loadingSchedule && (
                      <div className="mt-16 flex flex-col items-center justify-center gap-4">
                        ...
                        <p className="text-center">
                          Nenhuma das tuas unidades curriculares dá para trocar a turma no TTS
                        </p>
