const PrivacyPolicyPage = () => {
  return (
    <div className="m-16 flex flex-col gap-y-4 p-8">
      ...
      <article className="mb-8 flex flex-col gap-y-1">
        ...
        <ul className="ml-8 flex list-disc flex-col gap-y-2">
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to NIAEFEUP.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to TimeTableSelector, accessible from{' '}
              <a href="tts.niaefeup.pt" rel="external nofollow noreferrer noopener" target="_blank">
                tts.niaefeup.pt
              </a>
            </p>
          </li>
      ...
      <article className="flex flex-col gap-y-1">
        ...
        <h4 className="mt-4 text-lg font-bold">Usage Data</h4>
        <p>Usage Data is collected automatically when using the Service.</p>
        <h4 className="mt-4 text-lg font-bold">Tracking Technologies and Cookies</h4>
        <p>
        ...
        <h3 className="mt-4 text-xl font-bold">Use of Your Personal Data</h3>
        ...
        <h3 className="mt-4 text-xl font-bold">Retention of Your Personal Data</h3>
        <p>
